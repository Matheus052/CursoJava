...
public class Aluno {
	...
	public String toString() {
		return "Aluno [nome=" + nome + ", idade=" + idade + ", dataNascimento=" + dataNascimento + ", nomeMae="
				+ nomeMae + ", nomePai=" + nomePai + ", nomeEscola=" + nomeEscola + ", disciplina=" + disciplina + "]";
	}
	@Override
	public int hashCode() {
		return Objects.hash(dataNascimento, disciplina, idade, nome, nomeEscola, nomeMae, nomePai);
	}
	@Override
